#!/bin/bash
#rsync des series_tv de demetrius vers pegasus puis backup sur galactica
...
if [ -d "/mnt/osmc/pegasus1/series_tv" ]
	then
		echo -e "\n * pegasus1 ........ $DFpegasus1 %";
	else
...
if [ -d "/mnt/osmc/pegasus2/series_tv" ]
	then
...
if [ -d "/mnt/osmc/pegasus3/series_tv" ]
	then
...
if [ -d "/mnt/osmc/pegasus4/series_tv" ]
	then
...
if [ "$DFpegasus1" -le 80 ]
	then
		...
		rsync -rtv --progress /mnt/pi/demetrius/download_center/series_tv/ /mnt/osmc/pegasus1/series_tv/ && \
		rsync -rtv --progress /mnt/pi/demetrius/download_center/series_tv/ /mnt/osmc/pegasus1/series_tv/ && \
		...
		ssh osmc@192.168.1.21 'xbmc-send --action="UpdateLibrary(video)"' && echo -e "\nMise a jour médiathèque OSMC effectuée" && sleep 1 &&\
			if [ -d "/mnt/pi/galactica1/series_tv" ]
				then
					echo -e "\nBackup sur galactica1 initialisé" && \
					rsync -rtv --progress /mnt/pi/demetrius/download_center/series_tv/ /mnt/pi/galactica1/series_tv/ && \
					rsync -rtv --progress /mnt/pi/demetrius/download_center/series_tv/ /mnt/pi/galactica1/series_tv/ && \
		...
		if [ "$DFpegasus2" -le 80 ]
			then
				...
				rsync -rtv --progress /mnt/pi/demetrius/download_center/series_tv/ /mnt/osmc/pegasus2/series_tv/ && \
				rsync -rtv --progress /mnt/pi/demetrius/download_center/series_tv/ /mnt/osmc/pegasus2/series_tv/ && \
				echo -e "\n\nBond PRL effectué avec succès !" && \
				ssh osmc@192.168.1.21 'xbmc-send --action="UpdateLibrary(video)"' && echo -e "\nMise a jour médiathèque OSMC effectuée" && sleep 1 &&\
				if [ -d "/mnt/pi/galactica2/series_tv" ]
					then
						echo -e "\nBackup sur galactica2 initialisé" && \
						rsync -rtv --progress /mnt/pi/demetrius/download_center/series_tv/ /mnt/pi/galactica2/series_tv/ && \
						rsync -rtv --progress /mnt/pi/demetrius/download_center/series_tv/ /mnt/pi/galactica2/series_tv/ && \
						echo -e "\n\nBackup PRL effectué avec succès !" ;
					else
				...
				if [ "$DFpegasus3" -le 80 ]
					then
						...
						rsync -rtv --progress /mnt/pi/demetrius/download_center/series_tv/ /mnt/osmc/pegasus3/series_tv/ && \
						rsync -rtv --progress /mnt/pi/demetrius/download_center/series_tv/ /mnt/osmc/pegasus3/series_tv/ && \
						echo -e "\n\nBond PRL effectué avec succès !" && \
						ssh osmc@192.168.1.21 'xbmc-send --action="UpdateLibrary(video)"' && echo -e "\nMise a jour médiathèque OSMC effectuée" && sleep 1 &&\
						if [ -d "/mnt/pi/galactica3/series_tv" ]
							then
								echo -e "\nBackup sur galactica3 initialisé" && \
								rsync -rtv --progress /mnt/pi/demetrius/download_center/series_tv/ /mnt/pi/galactica3/series_tv/ && \
								rsync -rtv --progress /mnt/pi/demetrius/download_center/series_tv/ /mnt/pi/galactica3/series_tv/ && \
								echo -e "\n\nBackup PRL effectué avec succès !" ;
							else
						...
						if [ "$DFpegasus4" -le 80 ]
							then
								...
								rsync -rtv --progress /mnt/pi/demetrius/download_center/series_tv/ /mnt/osmc/pegasus4/series_tv/ && \
								rsync -rtv --progress /mnt/pi/demetrius/download_center/series_tv/ /mnt/osmc/pegasus4/series_tv/ && \
								echo -e "\n\nBond PRL effectué avec succès !" && \
								ssh osmc@192.168.1.21 'xbmc-send --action="UpdateLibrary(video)"' && echo -e "\nMise a jour médiathèque OSMC effectuée" && sleep 1 &&\
								if [ -d "/mnt/pi/galactica4/series_tv" ]
									then
										echo -e "\nBackup sur galactica4 initialisé" && \
										rsync -rtv --progress /mnt/pi/demetrius/download_center/series_tv/ /mnt/pi/galactica4/series_tv/ && \
										rsync -rtv --progress /mnt/pi/demetrius/download_center/series_tv/ /mnt/pi/galactica4/series_tv/ && \
										echo -e "\n\nBackup PRL effectué avec succès !" ;
									else
...
find /mnt/pi/demetrius/download_center/series_tv/ -type f -exec rm -riv {} \; && \
echo -e "\nSans notification contraire, aucun fichier n'a été supprimé du dossier series_tv." && sleep 1 && \
